  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        <RouterLink to="/skills" title="Tech Stack">
          <span class="lt-md:hidden">Skills</span>
          <div i-simple-icons-gnubash class="md:hidden" />
        </RouterLink>
        <RouterLink to="/experience" title="Experience">
          <span class="lt-md:hidden">Experience</span>
          <div i-ri-briefcase-4-fill class="md:hidden" />
        </RouterLink>

        <a href="https://github.com/soblvsk" target="_blank" title="GitHub" class="lt-md:hidden">
